...
<html>
    ...
    <body>
        <div id="app" class="container">
            ...
            <button v-if="setup.showFlux == false" v-on:click.prevent.stop="startNew({ setup: setup, configs: configs })" class="button is-primary">Add a New Flux To This Flow</button>
